...
class   ItemControllerTest {
    ...
    private final ItemDtoOutWithBookings itemDtoWithBookings = ItemDtoOutWithBookings.builder()
                                                                .id(itemDto.getId())
    ...
    void should_Create_Comment() throws Exception {
        CommentDtoOut commentDto = new CommentDtoOut(1L, "text", "author", current);
