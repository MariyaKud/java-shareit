...
class BookingServiceTest {
    ...
    void beforeEach() {
        ...
        bookerOut = new UserDto(booker.getId(), booker.getName(), booker.getEmail());
        ...
        itemOut = new ItemDtoOut(item.getId(), item.getName());
        ...
        bookingIn = BookingDtoIn.builder()
                .id(1L)
                .start(booking.getStart())
                .end(booking.getEnd())
    ...
    void should_find_all_bookings_by_booker_id() {
        ...
        verify(bookingRepository, times(0))
                .findByBookerIdAndStartLessThanEqualAndEndGreaterThanEqualOrderByStart(anyLong(), any(), any(), any());
