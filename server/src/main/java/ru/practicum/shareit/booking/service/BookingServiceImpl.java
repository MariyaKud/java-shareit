...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public BookingDtoOut createBooking(Long bookerId, BookingDtoIn bookingDto, LocalDateTime current) {
    ...
    public List<BookingDtoOut> getBookingsByBookerId(Long bookerId, StateBooking stateBooking, int from, int size) {
        ...
        switch (stateBooking) {
            case ALL:
                ...
                break;
            case CURRENT:
                result = bookingRepository.findByBookerIdAndStartLessThanEqualAndEndGreaterThanEqualOrderByStart(
                                                                              bookerId, current, current, pageable);
                break;
            case FUTURE:
