...
class ItemServiceImplTest {
    ...
    CommentDtoShort commentDtoShort;
    ...
    void beforeEach() {
        ...
        commentDtoShort = new CommentDtoShort("description");
    }
    ...
    void should_get_item_by_id() {
        ItemDtoWithBookings itemByIdForUserId = service.getItemByIdForUserId(user1.getId(), item.getId());
