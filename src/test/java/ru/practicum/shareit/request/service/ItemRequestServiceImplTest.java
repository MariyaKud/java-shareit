...
class ItemRequestServiceImplTest {
    ...
    void beforeEach() {
        ...
        requestIn = new ItemRequestDto("description");
    }
    ...
    void should_get_request_by_id() {
        ItemRequestDtoWithItems requestDtoWithItems = service.getRequestById(1L, 1L);

        assertThat(1L, equalTo(requestDtoWithItems.getId()));

        ItemRequestDtoWithItems requestToCheck = mapper.toDtoWithItems(itemRequest, List.of());
