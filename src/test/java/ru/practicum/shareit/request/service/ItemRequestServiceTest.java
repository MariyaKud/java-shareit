...
class ItemRequestServiceTest {
    ...
    ItemRequestDtoWithItems itemRequestDto;
    ...
    void beforeEach() {
        ...
        itemRequestDtoIn = new ItemRequestDto(itemRequest.getDescription());
        ...
        itemRequestDto = new ItemRequestDtoWithItems();
    ...
    void get_requests_by_user_id_without_items() {
        ...
        List<ItemRequestDtoWithItems> requests = requestService.getMyItemRequests(user.getId());
        ...
        Assertions.assertEquals(requests.get(0).getItems(), null);
    ...
    void get_all_requests_another_user() {
        ...
        List<ItemRequestDtoWithItems> requests = requestService.getAllItemRequests(user.getId(), 0, 10);
    ...
    void get_request_by_id() {
        ...
        ItemRequestDtoWithItems result = requestService.getRequestById(user.getId(), itemRequest.getId());
