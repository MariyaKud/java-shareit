...
class ItemRequestDtoWithItemsJsonTest {
    ...
    private final ItemRequestDtoWithItems dto = new ItemRequestDtoWithItems(1L,"description",
                                                                              current, items);

    @Test
    @DisplayName("should serialize")
    void test_serialize() throws Exception {
        JsonContent<ItemRequestDtoWithItems> result = jacksonTester.write(dto);
